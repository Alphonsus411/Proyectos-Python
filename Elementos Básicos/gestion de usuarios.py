...
def almacenar_datos_usuarios(nombre_usuario, contraseña, nombre, apellido, email, telefono, direccion, fecha_nacimiento,
                             fecha_alta, tipo_usuario):
    ...
    datos_usuarios.write(
        nombre_usuario + "," + contraseña + "," + nombre + "," + apellido + "," + email + "," + telefono + "," + direccion + "," + fecha_nacimiento + "," + fecha_alta + "," + tipo_usuario + "\n")
    # cerramos el archivo
